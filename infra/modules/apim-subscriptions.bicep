...
// APIM subscription PUTs update shared service metadata and can reject parallel writes with a
// stale ETag, so keep this small test-only collection sequential.
@batchSize(1)
