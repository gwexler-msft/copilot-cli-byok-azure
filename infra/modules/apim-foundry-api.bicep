...
var responsesItemPolicy = authMode == 'jwt' ? loadTextContent('../../policies/byok-foundry-responses-item-policy.xml') : loadTextContent('../../policies/byok-foundry-responses-item-policy-subkey.xml')
