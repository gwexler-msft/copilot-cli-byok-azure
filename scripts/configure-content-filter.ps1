...
.EXAMPLE
  ./configure-content-filter.ps1 -ResourceGroup rg-... -AccountName aif... -Apply -PolicyName byok-strict -ConfigPath ./scripts/content-filter.sample.json -AttachToDeployment gpt-5.6-sol
#>
