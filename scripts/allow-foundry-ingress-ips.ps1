...
.DESCRIPTION
  The commercial Foundry BACKEND that the Gov gateway reaches (docs/commercial-foundry-route.md)
  lives in the COMMERCIAL tenant and is called over the public internet from the Gov gateway's NAT
