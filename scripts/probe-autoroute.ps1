...
$results = @()
# Foundry /openai path
$results += Invoke-Probe -Label 'explicit-full'  -PathBase 'openai' -Model 'gpt-5.6-sol'  -Prompt $short
$results += Invoke-Probe -Label 'explicit-mini'  -PathBase 'openai' -Model 'gpt-5.6-luna' -Prompt $short
